...
#define TK_ERRO 263
#define TK_ID 264
#define TK_DECIMAL 265
#define TK_N_DECIMAL 266
...
{
       0,    48,    48,    55,    61,    64,    67,    68,    69,    72,
      81,    89,    98,   109,   114,   118,   122,   126
};
#endif
...
static const char *const yytname[] =
{
  ...
  "TK_DECIMAL", "TK_N_DECIMAL", "'+'", "'('", "')'", "'{'", "'}'", "';'",
  "'='", "$accept", "S", "BLOCO", "COMANDOS", "COMANDO", "DECLARACAO",
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,   266,    43,    40,    41,   123,   125,    59,    61
};
# endif
...
{
       1,    -2,    10,     3,   -17,     5,    -4,    -3,   -17,     8,
       9,    11,    12,     6,   -17,   -17,     7,    13,   -17,   -17,
      14,   -17,   -17,   -17,   -17,     4,   -17,    -3,     4,   -17,
      14,   -17,   -17
};
...
{
       0,     0,     0,     0,     1,     0,     0,     5,     2,     0,
       0,     0,     0,    17,    15,    16,     0,     0,     7,     8,
       6,     9,    10,    11,    12,     0,     3,     5,     0,    17,
      13,     4,    14
};
...
{
       9,    10,    11,    12,     1,     3,    13,    14,    15,    30,
       4,     7,    32,    29,    14,    15,     5,    21,    22,     6,
      23,    24,    31,    26,    25,     0,    28,     0,     0,     0,
      27
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,     3,     7,     9,    10,    11,    25,
       0,    15,    28,     9,    10,    11,    13,     9,     9,    14,
       9,     9,    27,    16,    18,    -1,    12,    -1,    -1,    -1,
      17
};
...
{
       0,     3,    20,     7,     0,    13,    14,    15,    21,     3,
       4,     5,     6,     9,    10,    11,    22,    23,    24,    25,
      26,     9,     9,     9,     9,    18,    16,    17,    12,     9,
      26,    22,    26
};
...
#line 109 "sintatica.y" /* yacc.c:1646  */
    {
				node temp = find(Tabela.begin(),Tabela.end(),(yyvsp[-2]).traducao);
				cout<<node.label;
			}
...
#line 127 "sintatica.y" /* yacc.c:1646  */
    {
				(yyval).traducao = "\tVariavel = " + (yyvsp[0]).label + ";\n";
			}
...
#line 133 "sintatica.y" /* yacc.c:1906  */
